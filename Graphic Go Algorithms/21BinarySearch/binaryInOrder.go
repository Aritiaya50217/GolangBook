...
/*	Binary Search Tree
	- left subtree ต้องไม่เป็นค่าว่าง
		- ค่าน้อยกว่า root node
	- right subtree ต้องไม่เป็นค่าว่าง
		- ค่ามากกว่า root node
	- left subtree และ right subtree สามารถมี หรือ ไม่มี node ต่อไปได้
*/
...
/*	binary search tree In-order traversal
	In-order traversal : left subtree -> root node -> right subtree (น้อย -> ปานกลาง -> มาก)
	- Start ฝั่งซ้ายเสมอ เพราะมีค่าน้อย
	- End ฝั่งขวาเสมอ เพราะมีค่ามากที่สุด
