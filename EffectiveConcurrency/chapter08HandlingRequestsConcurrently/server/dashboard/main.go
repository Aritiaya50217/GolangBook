...
func NewDashboardService() *DashboradService {
...
func (svc *DashboradService) GetDashboardData(ctx context.Context, userID string) DashboardData {
...
func (svc *DashboradService) SetDashboardConfig(ctx context.Context, userID string, params DashboardParams) {

}

func (svc *DashboradService) DashboardHandler(w http.ResponseWriter, req *http.Request) {
